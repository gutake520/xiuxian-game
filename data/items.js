export const ITEMS={
 ...
 'crit-charm':{id:'crit-charm',name:'锐锋佩',kind:'equipment',slot:'accessoryFate',critRate:10,glyph:'佩',description:'小妖掉落，提升暴击机会。'},
 'dodge-charm':{id:'dodge-charm',name:'轻身佩',kind:'equipment',slot:'accessoryFate',dodgeRate:10,glyph:'佩',description:'小妖掉落，提升闪避机会。'},
